def task1():
        ...
        def uniform_cost_search(goal, start):
                ...
                # insert the distance, starting index and parent 
                ...
                while (len(queue) > 0):
                        ...
                        if (p[1] in goal):
                                ...
                                # if the distance is less, set the new smallest distance
                                if (answer[index] > p[0]):
                                        answer[index] = p[0]
                        ...
                        if (p[1] not in visited):
                                ...
                                for i in range(len(graph[str(p[1])])):
                                        ...
                                        # append [new distance, neighbour node, parent which is the current node] 
        ...
        # print the distance 
        print("Shortest distance: " + str(answer[0]) + ".") 
        ...
        for item in solution:
                solution_string = solution_string + str(item) + "->" 
        solution_string = solution_string[:len(solution_string) - 2]
        solution_string = "Shortest path: " + solution_string + "."
